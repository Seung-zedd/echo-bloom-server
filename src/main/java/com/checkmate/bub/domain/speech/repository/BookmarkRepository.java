package com.checkmate.bub.domain.speech.repository;
...
public interface BookmarkRepository extends JpaRepository<BookmarkEntity, Long> {
    ...
    List<BookmarkEntity> findByUserNicknameOrderByCreatedAtDesc(String userNickname);
    
    // 특정 사용자의 특정 문장 북마크 조회
    Optional<BookmarkEntity> findByUserNicknameAndSentence(String userNickname, String sentence);
